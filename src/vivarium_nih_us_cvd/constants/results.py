...
STATE_PERSON_TIME_COLUMN_TEMPLATE = '{STATE}_person_time_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_SBP_{SBP_HEALTH_STATE}_LDL_{LDL_HEALTH_STATE}_ACS_{ACS_STATE}'
TRANSITION_COUNT_COLUMN_TEMPLATE = '{TRANSITION}_event_count_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_SBP_{SBP_HEALTH_STATE}_LDL_{LDL_HEALTH_STATE}_ACS_{ACS_STATE}'
